...
export default function ShowEvent() {
  ...
  if (loading) {
    return <div className="text-center py-16 text-lg font-semibold text-gray-600">Loading...</div>;
  }

  if (!event) {
    return (
      <div className="container mx-auto p-6 text-center">
        <h2 className="text-3xl font-extrabold mb-6 text-red-600">Event Not Found</h2>
        <p className="mb-6 text-gray-700 text-lg">The event you're looking for doesn't exist.</p>
        <button
