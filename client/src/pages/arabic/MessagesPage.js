...
export default function MessagesPage() {
  ...
  if (loading) return <p style={{ textAlign: 'center', marginTop: '30px' }}>جاري تحميل المحادثات...</p>;
  if (contacts.length === 0) return <p style={{ textAlign: 'center', marginTop: '30px' }}>لا توجد محادثات بعد.</p>;
    ...
    <div dir="rtl" style={{
      ...
      <ul style={{ listStyle: 'none', padding: 0 }}>
        {contacts.map(contact => (
          <li
            key={contact.id}
            onClick={() => navigate(`/ar/dm/${contact.id}`)}
            style={{
              cursor: 'pointer',
              padding: '16px 20px',
              marginBottom: '14px',
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{
                ...
                {contact.last_message || 'لا توجد رسائل بعد'} {getStatusIcon(contact)}
              </div>
            </div>
